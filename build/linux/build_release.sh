...
~/Qt/5.9.3/gcc_64/bin/qmake ${APROJECTS}/atools/atools.pro -spec linux-g++ CONFIG+=release
make -j4
...
~/Qt/5.9.3/gcc_64/bin/qmake ${APROJECTS}/littlenavmap/littlenavmap.pro -spec linux-g++ CONFIG+=release
make -j4
...
~/Qt/5.9.3/gcc_64/bin/qmake ${APROJECTS}/littlenavconnect/littlenavconnect.pro -spec linux-g++ CONFIG+=release
make -j4
...
~/Qt/5.9.3/gcc_64/bin/qmake ${APROJECTS}/littlexpconnect/littlexpconnect.pro -spec linux-g++ CONFIG+=release
make -j4
