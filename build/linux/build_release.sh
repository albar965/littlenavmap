...
~/Qt/5.9/gcc_64/bin/qmake ${APROJECTS}/atools/atools.pro -spec linux-g++ CONFIG+=release
make -j4
...
~/Qt/5.9/gcc_64/bin/qmake ${APROJECTS}/littlenavmap/littlenavmap.pro -spec linux-g++ CONFIG+=release
make -j4
