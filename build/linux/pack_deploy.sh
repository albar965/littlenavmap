...
scp ${APROJECTS}/deploy/LittleXpconnect.tar.gz ${SSH_DEPLOY_TARGET}/LittleXpconnect-linux-${FILENAME_LNC}.tar.gz
scp ${APROJECTS}/deploy/LittleNavconnect.tar.gz ${SSH_DEPLOY_TARGET}/LittleNavconnect-linux-${FILENAME_LXP}.tar.gz
