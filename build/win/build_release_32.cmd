...
if defined MARBLE_INC_PATH ( echo %MARBLE_INC_PATH% ) else ( set MARBLE_INC_PATH=%APROJECTS%\Marble-%CONF_TYPE%-%WINARCH%\include)
if defined MARBLE_LIB_PATH ( echo %MARBLE_LIB_PATH% ) else ( set MARBLE_LIB_PATH=%APROJECTS%\Marble-%CONF_TYPE%-%WINARCH%\lib)
