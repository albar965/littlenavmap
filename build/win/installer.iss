...
Type: files; Name: "{app}\Little Navmap\help\*.pdf"
Type: files; Name: "{autoprograms}\{#LnmAppName} {#AppSuffix}\Little Navmap*PDF*.lnk"
; Delete DGML to ensure updates ===================================================
...
Type: files; Name: "{app}\data\maps\earth\cartodark/cartodark.dgml"
Type: files; Name: "{app}\data\maps\earth\cartolight/cartolight.dgml"
Type: files; Name: "{app}\data\maps\earth\example/example.dgml"
Type: files; Name: "{app}\data\maps\earth\mapboxdark/mapboxdark.dgml"
Type: files; Name: "{app}\data\maps\earth\mapboxlight/mapboxlight.dgml"
Type: files; Name: "{app}\data\maps\earth\mapboxoutdoors/mapboxoutdoors.dgml"
Type: files; Name: "{app}\data\maps\earth\mapboxsatellite/mapboxsatellite.dgml"
Type: files; Name: "{app}\data\maps\earth\mapboxstreets/mapboxsatellitestreets.dgml"
Type: files; Name: "{app}\data\maps\earth\mapboxsatellitestreets/mapboxsatellitestreets.dgml"
Type: files; Name: "{app}\data\maps\earth\mapboxuser/mapboxuser.dgml"
Type: files; Name: "{app}\data\maps\earth\maptilertopo/maptilertopo.dgml"
Type: files; Name: "{app}\data\maps\earth\openflightmaps/openflightmaps.dgml"
Type: files; Name: "{app}\data\maps\earth\openstreetmap/openstreetmap.dgml"
Type: files; Name: "{app}\data\maps\earth\opentopomap/opentopomap.dgml"
Type: files; Name: "{app}\data\maps\earth\osm-de/osm-de.dgml"
Type: files; Name: "{app}\data\maps\earth\osm-fr/osm-fr.dgml"
Type: files; Name: "{app}\data\maps\earth\plain/plain.dgml"
Type: files; Name: "{app}\data\maps\earth\political/political.dgml"
Type: files; Name: "{app}\data\maps\earth\srtm/srtm.dgml"
Type: files; Name: "{app}\data\maps\earth\srtm2/srtm2.dgml"
Type: files; Name: "{app}\data\maps\earth\stadiastamenterrain/stadiastamenterrain.dgml"
Type: files; Name: "{app}\data\maps\earth\thunderforestatlas/thunderforestatlas.dgml"
Type: files; Name: "{app}\data\maps\earth\thunderforestlandscape/thunderforestlandscape.dgml"
Type: files; Name: "{app}\data\maps\earth\us-ifr-high/us-ifr-high.dgml"
Type: files; Name: "{app}\data\maps\earth\us-ifr-low/us-ifr-low.dgml"
Type: files; Name: "{app}\data\maps\earth\us-vfr-sectional/us-vfr-sectional.dgml"
Type: files; Name: "{app}\data\maps\earth\us-vfr-terminal/us-vfr-terminal.dgml"
...
Type: files; Name: "{app}\libmarblewidget-qt5.dll"
...
; Delete other Marble files ===================================================
Type: files; Name: "{app}\customize\little_navmap_alternative_nightstyle.ini"
...
; Delete Little Navconnect files ===================================================
