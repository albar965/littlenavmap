...
Type: files; Name: "{app}\printsupport\windowsprintersupport.dll"
; SimConnect ===================================================
Type: files; Name: "{app}\Little Navconnect\SimConnect.dll"
Type: files; Name: "{app}\SimConnect.dll"
; Customize ===================================================
Type: files; Name: "{app}\customize\aircraft-icons.zip"
Type: files; Name: "{app}\customize\userpoint-icons.zip"
...
; Web files ===================================================
Type: files; Name: "{app}\web\aircraft.html"
Type: files; Name: "{app}\web\aircraft_doc.html"
Type: files; Name: "{app}\web\airport.html"
Type: files; Name: "{app}\web\assets\2021-a\layout-internal.css"
Type: files; Name: "{app}\web\assets\2021-a\look-internal.css"
Type: files; Name: "{app}\web\assets\2021-a\map.css"
Type: files; Name: "{app}\web\assets\2021-a\menu.js"
Type: files; Name: "{app}\web\assets\2021-a\plugins.js"
Type: files; Name: "{app}\web\assets\2021-a\scripts.js"
Type: files; Name: "{app}\web\assets\2021-a\toolbarAPI.js"
Type: files; Name: "{app}\web\assets\2021-a\uncategorisedremainders.js"
Type: files; Name: "{app}\web\assets\base.js"
Type: files; Name: "{app}\web\assets\scripts.js"
Type: files; Name: "{app}\web\assets\styles.css"
Type: files; Name: "{app}\web\assets\uitoggle.js"
Type: files; Name: "{app}\web\flightplan.html"
Type: files; Name: "{app}\web\flightplan_doc.html"
Type: files; Name: "{app}\web\html\legacy\legacy.html"
Type: files; Name: "{app}\web\images\point-down.cur"
Type: files; Name: "{app}\web\images\point-left.cur"
Type: files; Name: "{app}\web\images\point-right.cur"
Type: files; Name: "{app}\web\images\point-up.cur"
Type: files; Name: "{app}\web\images\there.cur"
Type: files; Name: "{app}\web\javascript_and_css\uitoggle.js"
Type: files; Name: "{app}\web\legacy.html"
Type: files; Name: "{app}\web\map.html"
Type: files; Name: "{app}\web\ol\index.bundle.js"
Type: files; Name: "{app}\web\ol\index.html"
Type: files; Name: "{app}\web\ol\index.html"
Type: files; Name: "{app}\web\plugins\example-plugin_documentation\index.html"
Type: files; Name: "{app}\web\preventstandbyvideo.html"
Type: files; Name: "{app}\web\progress.html"
Type: files; Name: "{app}\web\progress_doc.html"
