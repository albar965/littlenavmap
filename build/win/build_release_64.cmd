...
set ATOOLS_NO_CRASHHANDLER=%ATOOLS_NO_CRASHHANDLER_64%
...
if defined PATH_SHARED ( echo PATH_SHARED=%PATH_SHARED% ) else ( set PATH_SHARED=C:\Qt\6.5.3\mingw81_64\bin;C:\Qt\Tools\mingw810_64\bin)
