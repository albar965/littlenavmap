...
The new provided MAGDEC.BGL table correct all magnetic variations for FS2004 & FSX/P3D based on values calculated from the IGRF-12 models at epox 2017.
Values were calculated according to the exact mathematical models
...
Updated MAGDEC.BGL files for both FS2004 and FSX-P3D on 1/1/2017 are provided.  
...
3) KEEP A COPY of the old file somewhere or rename it MAGDEC.BGL.BAK (DO NOT USE a bgl extension if the file is kept in its native directory)
