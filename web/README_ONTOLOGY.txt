...
/plugins/example-plugin-1   documentation of how to create a plugin
...
NOTE: the version of the web frontend is NOT the version of the map HTML as passed to a plugin. The version of the map HTML as passed to a plugin is a number increased by 1 for every compatibility-breaking change to the map.html file when delivered in a release.
