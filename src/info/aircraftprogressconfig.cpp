...
void AircraftProgressConfig::progressConfiguration()
{
  ...
  treeDialog.addItem2(destItem, pid::DEST_DIST_TIME_ARR, tr("Distance, Time and Arrival"),
                      tr("Distance to, time to and arrival time in UTC at destination."));
  treeDialog.addItem2(destItem, pid::DEST_FUEL, tr("Fuel"),
  ...
  treeDialog.addItem2(tocItem, pid::TOC_DIST_TIME_ARR, tr("Distance, Time and Arrival"),
  ...
  treeDialog.addItem2(todItem, pid::TOD_DIST_TIME_ARR, tr("Distance, Time and Arrival"),
  ...
  treeDialog.addItem2(nextItem, pid::NEXT_CROSS_TRACK_DIST, tr("Cross Track Distance"),
                      tr("Distance to flight plan leg.\n"
                         "%1 means aircraft is left of flight plan leg (fly right) and %2 means right of leg.")
                      .arg(TextPointer::getPointerRight(), TextPointer::getPointerLeft()));
  ...
  treeDialog.addItem2(aircraftItem, pid::AIRCRAFT_ENDURANCE, tr("Endurance"),
                      tr("Estimated endurance based on current fuel flow and groundspeed\n"
  ...
  treeDialog.addItem2(altitudeItem, pid::ALT_INDICATED_OTHER, tr("Indicated Alternate"),
                      tr("Indicated altitude additional display in other\n"
  ...
  treeDialog.addItem2(altitudeItem, pid::ALT_GROUND_ELEVATION, tr("Ground Elevation"),
                      tr("Ground elevation above normal as reported by simulator."));
  ...
  treeDialog.addItem2(speedItem, pid::SPEED_INDICATED, tr("Indicated"),
                      tr("Aircraft indicated airspeed.\n"
                         "Shows orange and red if faster than %L1 kts below %L2 ft.").arg(250).arg(10000));
  treeDialog.addItem2(speedItem, pid::SPEED_INDICATED_OTHER, tr("Indicated Alternate"),
                      tr("Aircraft indicated airspeed additional display in other\n"
  ...
  treeDialog.addItem2(speedItem, pid::SPEED_GROUND_OTHER, tr("Ground Alternate"),
                      tr("Aircraft groundspeed additional display in other\n"
                         "than selected default units (kts, km/h or mph)."));
  treeDialog.addItem2(speedItem, pid::SPEED_TRUE, tr("True Airspeed"), tr("Aircraft true airspeed."));
  treeDialog.addItem2(speedItem, pid::SPEED_TRUE_OTHER, tr("True Alternate"),
                      tr("Aircraft true speed additional display in other\n"
                         "than selected default units (kts, km/h or mph)."));
  ...
  treeDialog.addItem2(speedItem, pid::SPEED_VERTICAL_OTHER, tr("Vertical Alternate"),
                      tr("Aircraft vertical speed additional display in other\n"
  ...
  treeDialog.addItem2(descentItem, pid::DESCENT_ANGLE_SPEED, tr("Angle and Speed"),
  ...
  treeDialog.addItem2(descentItem, pid::DESCENT_VERT_ANGLE_NEXT, tr("Angle and Speed to Next"),
                      tr("Vertical descent angle and speed needed to arrive at\n"
                         "the calculated altitude at the next waypoint."));

  // Environment ==========================================================================================================
  QTreeWidgetItem *envItem = treeDialog.addTopItem1(tr("Environment"));
  treeDialog.addItem2(envItem, pid::ENV_WIND_DIR_SPEED, tr("Wind Direction and Speed"),
                      tr("Wind direction and speed at aircraft.\n"
  ...
  treeDialog.addItem2(envItem, pid::ENV_TAT, tr("Total Air Temperature"),
                      tr("Total air temperature (TAT).\n"
                         "Also indicated air temperature (IAT) or ram air temperature."));
  treeDialog.addItem2(envItem, pid::ENV_SAT, tr("Static Air Temperature"),
                      tr("Static air temperature (SAT).\n"
