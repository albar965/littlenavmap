...
SimActionsController::~SimActionsController()
{
...
WebApiResponse SimActionsController::infoAction(WebApiRequest request)
{
  ...
  float windDir = normalizeCourse(simConnectData.getUserAircraft().getWindDirectionDegT() -
                                  simConnectData.getUserAircraft().getMagVarDeg());
