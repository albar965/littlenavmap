...
enum PrintFlightPlanOpt
{
  ...
  FLIGHTPLAN = 0x1000,
  DEPARTURE_ANY = DEPARTURE_OVERVIEW | DEPARTURE_RUNWAYS | DEPARTURE_COM | DEPARTURE_APPR,
  DESTINATION_ANY = DESTINATION_OVERVIEW | DESTINATION_RUNWAYS | DESTINATION_COM | DESTINATION_APPR
};
